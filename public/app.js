(function() {
  ...
  riot.mount('app', {
    ...
    items: [
        { url: 'images/1.jpg', palette: [{ color: 'ff0000', name: 'Red' }, { color: 'ff0000', name: 'Red' }, { color: '0000ff', name: 'Blue' }, { color: 'ffff00', name: 'Yellow' }] },
        { url: 'images/1.jpg', palette: [{ color: 'ff0000', name: 'Red' }, { color: '0000ff', name: 'Blue' }, { color: 'ffff00', name: 'Yellow' }] },
        { url: 'images/1.jpg', palette: [{ color: '00ff00', name: 'Green' }, { color: '000000', name: 'Black' }, { color: 'ffa500', name: 'Orange' }] },
        { url: 'images/1.jpg', palette: [{ color: 'ff0000', name: 'Red' }, { color: '0000ff', name: 'Blue' }, { color: 'ffff00', name: 'Yellow' }] },
        { url: 'images/1.jpg', palette: [{ color: 'ff0000', name: 'Red' }, { color: '0000ff', name: 'Blue' }, { color: 'ffff00', name: 'Yellow' }] },
        { url: 'images/1.jpg', palette: [{ color: 'ff0000', name: 'Red' }, { color: '0000ff', name: 'Blue' }, { color: 'ffff00', name: 'Yellow' }] }
    ]
