...
riot.tag('image-edit-dialog', '<ui-dialog t="Edit Image"> <form class="image-edit-form" onsubmit="{ parent.complete }"> <div class="ui-form-error" if="{ parent.error }">{ parent.error }</div> <div class="ui-form-item" if="{ parent.url }"> <image-item url="{ parent.url }" palette="{ parent.palette }"></image-item> </div> <div class="ui-form-buttons"> <input class="form-submit-btn" type="submit" value="Complete"> </div> </form> </ui-dialog>', '.form-error { color: red; } .image-edit-form { text-align: center; } .image-edit-form .image-item { display: inline-block; }', function(opts) {
  var self = this;
...
riot.tag('image-page', '<div class="ui-nav"> <button class="upload-file-btn" >Add Image</button> </div> <div class="ui-loading" if="{ loading }"></div> <div class="ui-message" if="{ error }">{ error }</div> <div if="{ ! loading && ! error }"> <image-list items="{ items }"></image-list> </div> <image-edit-dialog></image-edit-dialog>', function(opts) {
  var self = this;
